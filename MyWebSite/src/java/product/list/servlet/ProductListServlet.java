...
import product.mockup.model.ProductMockup;
import product.mockup.model.ShoppingCart;
...
public class ProductListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        products = ProductMockup.getProducts();
        session.setAttribute("products", products);
        response.sendRedirect("index.jsp#productlist");
//        List<Product> products = ProductMockup.getProducts();
//        request.setAttribute("products", products);
//        getServletContext().getRequestDispatcher("/index").forward(request, response);

//        response.sendRedirect("/MyWebSite/index.jsp#productlist");
    }
