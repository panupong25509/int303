...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background-color: ${cookie.bgColor.value}">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="#multiplication">multiplication table</a>
                        </li> 
                        <li class="nav-item">
                ...
                <div class="intro-text">
                    <div class="col-sm-4 mx-auto">
                        <div class="team-member">
                            ...
                            ---------------------------------<br>
                            <a onclick="ShowSelectBg()" style="cursor: pointer">Choose Background Color</a><br>
                            ---------------------------------
                            <div id="choosebackground" style="display: none">
                                <form action="ChooseBackground" method="post">
                                    <select name="bgColor">
                                        <option ${cookie.bgColor == null ? "selected" : ""}>Color</option>
                                        <option value="slategray" style="background-color: slategray" ${cookie.bgColor != null && cookie.bgColor.value == "slategray" ? "selected" : ""}>Slategray</option>
                                        <option value="navy" style="background-color: navy" ${cookie.bgColor != null && cookie.bgColor.value == "navy" ? "selected" : ""}>Navy Blue</option>
                                        <option value="silver" style="background-color: silver" ${cookie.bgColor != null && cookie.bgColor.value == "silver" ? "selected" : ""}>Silver</option>
                                    </select>
        ...
        <section style="min-height: 100vh;" id="func">
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <a href="#multiplication" style="text-decoration: none;" class="col-md-3 js-scroll-trigger">
                        <div style="cursor: pointer;">
                            <span class="fa-stack fa-4x">
                                <i class="fa fa-circle fa-stack-2x text-primary"></i>
                                <i class="fa fa-check fa-stack-1x fa-inverse"></i>
                            </span>
                            <h4 class="service-heading">MULTIPLICATION TABLE</h4>
                        </div>
                    </a>
        ...
        <!-- multiplication -->
        <section style="height: 100vh;" id="multiplication">
        ...
        <!-- Product List -->
        <section style="min-height: 100vh;background-color: #fed136;" id="productlist">
            <div class="container">
                <div class="row">
        ...
        <!-- Cart -->
        <section style="min-height: 100vh;" id="cart">
            <div class="container">
                <div class="row">
                    <div class="col-10 mx-auto">
                        <h1>Cart</h1>
        ...
        <script>
            ...
            function ShowSelectBg() {
                if(showBg){
                    document.getElementById("choosebackground").style.display = "none";
                    showBg = false;
                } else {
                    document.getElementById("choosebackground").style.display = "block";
                    showBg = true;
                }
            }
